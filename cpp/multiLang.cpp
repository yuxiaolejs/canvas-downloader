...
void multiLang::init()
{
    ...
    en_us.insert({"step0", "Step 0/3: Initialization"});
    en_us.insert({"step1", "Step 1/3: Select a module"});
    en_us.insert({"step2", "Step 2/3: Select a file"});
    en_us.insert({"step3", "Step 3/3: Downloading"});
    ...
    zh_tw.insert({"step0", "步驟 0/3: 初始化"});
    zh_tw.insert({"step1", "步驟 1/3: 選擇模塊"});
    zh_tw.insert({"step2", "步驟 2/3: 選擇文檔"});
    zh_tw.insert({"step3", "步驟 3/3: 正在下載"});
    ...
    zh_cn.insert({"step0", "步骤 0/3: 初始化"});
    zh_cn.insert({"step1", "步骤 1/3: 选择模块"});
    zh_cn.insert({"step2", "步骤 2/3: 选择文件"});
    zh_cn.insert({"step3", "步骤 3/3: 正在下载"});
